...
const ONBOARDING_STEPS: OnboardingStep[] = [
  ...
  },
  {
    id: "agents",
    icon: Users,
    title: "ทีมที่ปรึกษา AI พร้อมใช้งาน",
    description: "ทีมงานช่วย setup ที่ปรึกษาให้แล้ว — แต่ละตัวมีบทบาทต่างกัน (นักบัญชี, ที่ปรึกษาภาษี, ผู้สอบบัญชี)",
  },
  {
    id: "research",
    icon: MessageSquare,
    title: "เริ่มการประชุม",
    description: "ไปที่ 'ห้องประชุม' พิมพ์วาระประชุม เช่น 'วิเคราะห์งบการเงิน' แล้ว AI ทั้งทีมจะถกเถียงและสรุปมติให้",
  },
  {
    id: "shortcuts",
    icon: Command,
