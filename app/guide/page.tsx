...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    details: [
      "ไปที่หน้า ⚙️ ตั้งค่า > ส่วน ข้อมูลบริษัท",
  ...
  },
  {
    ...
    details: [
      'ในหน้า 👥 ทีม Agents กดปุ่ม "📚 Knowledge" ที่ Agent ที่ต้องการ',
  ...
  },
  {
    ...
    tips: [
      ...
      "ประวัติการประชุมเก็บไว้ในระบบ ดูย้อนหลังได้จาก 📜 ประวัติ",
    ],
  },
  {
    id: "tokens",
    ...
    <div className="min-h-screen" style={{ background: "var(--bg)" }}>
      <div className="max-w-4xl mx-auto px-4 py-8 sm:py-12">
        ...
        <div className="text-center mb-10">
          <h1 className="text-2xl sm:text-3xl font-black mb-3" style={{ color: "var(--text)" }}>
        ...
        <div className="rounded-xl p-5 mb-8 border" style={{ background: "color-mix(in srgb, var(--accent) 5%, var(--card))", borderColor: "color-mix(in srgb, var(--accent) 30%, transparent)" }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
            {[
              ...
              <a key={s.step} href={s.link} className="flex items-center gap-3 p-3 rounded-lg transition-all hover:scale-[1.02]" style={{ background: "var(--card)", border: "1px solid var(--border)" }}>
                <div className="w-8 h-8 rounded-full flex items-center justify-center text-sm font-black flex-shrink-0" style={{ background: "var(--accent)", color: "#000" }}>
                  {s.step}
                </div>
          ...
          {STEPS.map((step, idx) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-black flex-shrink-0" style={{ background: isOpen ? "var(--accent)" : "var(--surface)", color: isOpen ? "#000" : "var(--text-muted)" }}>
                    {idx + 1}
                  </div>
        ...
        <div className="mt-12 text-center">
          <a href="/research" className="inline-block px-8 py-3 rounded-xl font-bold text-sm transition-all hover:scale-105" style={{ background: "var(--accent)", color: "#000" }}>
            🏛️ เข้าห้องประชุม AI เลย
          </a>
